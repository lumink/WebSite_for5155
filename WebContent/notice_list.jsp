...
<body>
		...
		<div>
			<%
				...
				try {
					...
					String strSQL = "SELECT COUNT(*) FROM notice_board";
 ...
 %> <a href="notice_view.jsp?idx=<%=idx%>"><%=title%></a>
			...
			<form action="notice_search.jsp">
				<table>
					<tr>
						<td align="center" width="700px"><input type="text"
							name="search" placeholder="검색할 내용"> <select
							name=search_value>
			...
			%>
			<a href="notice_list.jsp?pageNum=1">[<<]</a> <a
				href="notice_list.jsp?pageNum=<%=currentPage - 1%>">[<]</a>
			<%
				}
			...
			%>
			<a href="notice_list.jsp?pageNum=<%=setPage%>">[<%=setPage%>]
			</a>
			<%
				}
						setPage = setPage + 1;
			...
			%>
			<a href="notice_list.jsp?pageNum=<%=currentPage + 1%>">[>]</a> <a
				href="notice_list.jsp?pageNum=<%=lastPage%>">[>>]</a>
			<%
				}
				}
			%>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr align="center">
					...
					<td><input type=button value="글쓰기"
						OnClick="window.location='notice_write.jsp'"></td>
					<%
						}
					%>
				</tr>
...
<br>
<br>
<footer id="footer"> <nav id="footer_list">
<ul>
	<li><font size="2" color="gray"> Copyright (c)
			SISS-Corporation. All Rights Reserved.</font></li>
