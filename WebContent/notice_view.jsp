...
<div>
	...
	<div>
<form method="post" action="notice_comment.jsp?idx=<%=idx%>" >
<center>
<table>
  <tr>
   <td>
...
<table width="700">
<%				
		String sql3 = "select * from notice_comment where textnum =" + idx;
...
%>
						<tr>
							...
							<td align="right" width="40px" colspan="3">
								...
								OnClick="window.location='notice_comment_delete.jsp?textnum=<%=num2%>'">
								<%}%>
							</td>
						</tr>
						<%}%>
...
<table width="700">
     ...
     <tr align="center">
      <td width="0">&nbsp;</td>
      <td colspan="2" width="399"><input type=button value="글쓰기"  OnClick="window.location='notice_write.jsp'">
